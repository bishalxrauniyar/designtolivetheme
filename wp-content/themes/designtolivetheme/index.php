    ...
    <div
        ...
        <div
            ...
            <div class="flex flex-col justify-start w-full text-xl p-2">
                ...
                <p class="md:text-xl text-sm"><?php echo get_theme_mod('custom_sellery_price1_settings') ?>$</p>
            </div>
        </div>
        <!-- // iteam2  (Silver plate) -->
        <div
            ...
            <div class="flex w-full h-full">
                <img
                    src="<?php echo get_theme_mod('custom_sellery_image2_control_setting') ?>"
                    alt="card image"
                    class="w-full h-full object-cover" />
            </div>
            <div class="flex flex-col justify-start w-full text-xl p-2">
                <p class="md:text-xl font-medium text-sm"><?php echo get_theme_mod('custom_sellery_content2_settings') ?></p>
                <p class="md:text-xl text-sm"><?php echo get_theme_mod('custom_sellery_price2_settings') ?>$</p>
            </div>
        </div>
        <!-- // iteam3  (Norvadic container) -->
        <div
            class="flex flex-col items-stretch md:w-1/4 h-full border-b hover:shadow-md">
            <div class="flex w-full h-full">
                <img
                    src="<?php echo get_theme_mod('custom_sellery_image3_control_setting') ?>"
                    alt="card image"
                    class="w-full h-full object-cover" />
            </div>
            <div class="flex flex-col justify-start w-full text-xl p-2">
                <p class="md:text-xl font-medium text-sm"><?php echo get_theme_mod('custom_sellery_content3_settings') ?></p>
                <p class="md:text-xl text-sm"><?php echo get_theme_mod('custom_sellery_price3_settings') ?>$</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div
        ...
        <div
            ...
            <h1
                ...
                <?php echo get_theme_mod('custom_new_collection_title_settings'); ?>
            </h1>
            <p class="md:text-xl text-sm text-gray-700 flex flex-wrap">
                <?php echo get_theme_mod('custom_new_collection_content_settings'); ?>
            </p>
            <button
        ...
        <div
            ...
            <div
                ...
                <div class="w-38 h-1/2">
                    <img
                        src="<?php echo get_theme_mod('custom_new_collection_image1_control_setting') ?>"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="w-38 h-1/2">
                    <img
                        src="<?php echo get_theme_mod('custom_new_collection_image2_control_setting') ?>"
                        class="w-full h-auto object-contain" />
                </div>
            </div>
            <!-- Right Column: Single Image -->
            <div class="flex items-stretch ml-2 h-auto">
                <img src="<?php echo get_theme_mod('custom_new_collection_image3_control_setting'); ?>" class="w-full object-cover" />
            </div>
        </div>
    </div>
</div>
...
<div class="flex items-center justify-center md:h-screen md:mt-0 md:mb-0">
    <div
        ...
        <div class="md:w-1/2 w-full h-full">
            <img
                src="<?php echo get_theme_mod('custom_workshop_image_control_setting')  ?>"
                alt="image"
                class="w-full h-full object-cover" />
        </div>
        <div
            ...
            <h1 class="md:text-4xl text-3xl font-medium md:font-bold">
                <?php echo get_theme_mod('custom_workshop_title_settings'); ?>
            </h1>
            <p class="md:text-xl text-sm">
                <?php echo get_theme_mod('custom_workshop_content_settings'); ?>
            </p>
            <button
...
<div
    ...
    <h1 class="md:text-4xl text-3xl font-medium md:font-bold">
        <?php echo get_theme_mod('custom_our_employee_title_settings'); ?>
    </h1>
    ...
    <div
        ...
        <div
            ...
            <img
                src="<?php echo get_theme_mod('custom_our_employee_image1_control_setting') ?>"
                alt="card image"
                class="w-[100px] h-[100px] rounded-full mt-10" />
            <p class="text-xl font-semibold"><?php echo get_theme_mod('custom_our_employee_name1_settings') ?></p>
            <p class="text-center justify-center md:text-xl text-sm px-8">
                <?php echo get_theme_mod('custom_our_employee_message1_settings'); ?>
            </p>
        </div>
        <div
            class="flex flex-col w-full h-full space-y-6 items-center justify-center">
...
<div
    ...
    <div
        ...
        <div class="flex items-stretch w-100 sm:w-1/2 h-full">
            <img src="<?php echo get_theme_mod('custom_gallery_image1_control_setting') ?>" class="w-full h-full object-cover" />
        </div>
        ...
        <div
            ...
            <div class="w-full h-1/2">
                <img src="<?php echo get_theme_mod('custom_gallery_image2_control_setting') ?>" class="w-full h-full object-cover" />
            </div>
            <div
                class="flex items-center justify-center md:space-x-6 space-x-0 w-full h-1/2">
                <div class="w-1/2 h-full">
                    <img src="<?php echo get_theme_mod('custom_gallery_image3_control_setting') ?>" class="w-full h-full object-cover" />
                </div>
                <div class="w-1/2 h-full">
                    <img src="<?php echo get_theme_mod('custom_gallery_image4_control_setting') ?>" class="w-full h-full object-cover" />
                </div>
            </div>
        </div>
    </div>
...
<div
    class="relative md:h-screen h-[500px] bg-slate-100 flex justify-center items-center md:mt-0 md:mb-0 md:p-2">
    <img
        src="<?php echo get_theme_mod('custom_our_story_image_control_setting') ?>"
        alt="hero image"
        class="absolute inset-0 w-full h-full object-cover z-0" />
    <!-- Dark overlay -->
    ...
    <div class="w-full md:px-24">
        <div
            ...
            <h1 class="text-4xl font-bold text-white"><?php echo get_theme_mod('custom_our_story_title_settings') ?></h1>
            <p class="md:text-xl text-sm text-start text-slate-200">
                <?php echo get_theme_mod('custom_our_story_content_settings') ?>
            </p>
        </div>
    </div>
</div>
